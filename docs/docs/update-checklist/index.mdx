...
When you initiate a pull request to the nr1-catalog repository for an update to an existing Nerdpack, the following items will appear in the pull request template.
